...
\par The International Movie Database (IMDb) \cite{imdb} with its over 3 million listed titles provides a great resources for information about all sorts of movies. Maintaining this amount of data is quite challenging as new movies need to be added all the time.
...
\bibitem{imdb} \emph{International Movie Database}, www.imdb.com
\end{thebibliography}
